...
public class PascalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PascalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBlockAccess().getConstantAssignment_0(), "rule__Block__ConstantAssignment_0");
			...
			builder.put(grammarAccess.getBlockAccess().getAbstractionAssignment_3(), "rule__Block__AbstractionAssignment_3");
			builder.put(grammarAccess.getBlockAccess().getStatementAssignment_4(), "rule__Block__StatementAssignment_4");
			...
			builder.put(grammarAccess.getUnsigned_numberAccess().getIntegerAssignment(), "rule__Unsigned_number__IntegerAssignment");
			builder.put(grammarAccess.getSigned_numberAccess().getIntegerAssignment(), "rule__Signed_number__IntegerAssignment");
			...
			builder.put(grammarAccess.getRepetitive_statementAccess().getForStmtAssignment(), "rule__Repetitive_statement__ForStmtAssignment");
			...
			builder.put(grammarAccess.getConditional_statementAccess().getIfStmtAssignment(), "rule__Conditional_statement__IfStmtAssignment");
