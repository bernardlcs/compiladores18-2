 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.pascal.pascal.simple_type#getUbrange <em>Ubrange</em>}</li>
...
{
  /**
   * Returns the value of the '<em><b>Ubrange</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Ubrange</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Ubrange</em>' containment reference.
   * @see #setUbrange(subrange_type)
   * @see org.xtext.example.pascal.pascal.PascalPackage#getsimple_type_Ubrange()
   * @model containment="true"
   * @generated
   */
  subrange_type getUbrange();

  /**
   * Sets the value of the '{@link org.xtext.example.pascal.pascal.simple_type#getUbrange <em>Ubrange</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Ubrange</em>' containment reference.
   * @see #getUbrange()
   * @generated
   */
  void setUbrange(subrange_type value);
