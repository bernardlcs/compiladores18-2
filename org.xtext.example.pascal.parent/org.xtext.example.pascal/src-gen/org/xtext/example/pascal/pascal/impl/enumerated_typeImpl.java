 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.pascal.pascal.impl.enumerated_typeImpl#getInitialConst <em>Initial Const</em>}</li>
 *   <li>{@link org.xtext.example.pascal.pascal.impl.enumerated_typeImpl#getFinalConst <em>Final Const</em>}</li>
 *   <li>{@link org.xtext.example.pascal.pascal.impl.enumerated_typeImpl#getSubrange <em>Subrange</em>}</li>
 *   <li>{@link org.xtext.example.pascal.pascal.impl.enumerated_typeImpl#getConst <em>Const</em>}</li>
 * </ul>
 *
 * @generated
 */
public class enumerated_typeImpl extends MinimalEObjectImpl.Container implements enumerated_type
{
  ...
  public NotificationChain basicSetInitialConst(constant newInitialConst, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.ENUMERATED_TYPE__INITIAL_CONST, oldInitialConst, newInitialConst);
  ...
  public void setInitialConst(constant newInitialConst)
  {
    if (newInitialConst != initialConst)
    {
      ...
      if (initialConst != null)
        msgs = ((InternalEObject)initialConst).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ENUMERATED_TYPE__INITIAL_CONST, null, msgs);
      if (newInitialConst != null)
        msgs = ((InternalEObject)newInitialConst).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ENUMERATED_TYPE__INITIAL_CONST, null, msgs);
      msgs = basicSetInitialConst(newInitialConst, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.ENUMERATED_TYPE__INITIAL_CONST, newInitialConst, newInitialConst));
  }
  ...
  public NotificationChain basicSetFinalConst(constant newFinalConst, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.ENUMERATED_TYPE__FINAL_CONST, oldFinalConst, newFinalConst);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setFinalConst(constant newFinalConst)
  {
    if (newFinalConst != finalConst)
    {
      NotificationChain msgs = null;
      if (finalConst != null)
        msgs = ((InternalEObject)finalConst).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ENUMERATED_TYPE__FINAL_CONST, null, msgs);
      if (newFinalConst != null)
        msgs = ((InternalEObject)newFinalConst).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ENUMERATED_TYPE__FINAL_CONST, null, msgs);
      msgs = basicSetFinalConst(newFinalConst, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.ENUMERATED_TYPE__FINAL_CONST, newFinalConst, newFinalConst));
  }
  ...
  public void setSubrange(String newSubrange)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.ENUMERATED_TYPE__SUBRANGE, oldSubrange, subrange));
  }
  ...
  public NotificationChain basicSetConst(constant newConst, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.ENUMERATED_TYPE__CONST, oldConst, newConst);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setConst(constant newConst)
  {
    if (newConst != const_)
    {
      NotificationChain msgs = null;
      if (const_ != null)
        msgs = ((InternalEObject)const_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ENUMERATED_TYPE__CONST, null, msgs);
      if (newConst != null)
        msgs = ((InternalEObject)newConst).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ENUMERATED_TYPE__CONST, null, msgs);
      msgs = basicSetConst(newConst, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.ENUMERATED_TYPE__CONST, newConst, newConst));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.ENUMERATED_TYPE__INITIAL_CONST:
        return basicSetInitialConst(null, msgs);
      case PascalPackage.ENUMERATED_TYPE__FINAL_CONST:
        return basicSetFinalConst(null, msgs);
      case PascalPackage.ENUMERATED_TYPE__CONST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case PascalPackage.ENUMERATED_TYPE__SUBRANGE:
        return getSubrange();
      case PascalPackage.ENUMERATED_TYPE__CONST:
        return getConst();
    }
