...
public interface PascalPackage extends EPackage
{
   ...
   * @generated
   */
  int VARIABLE_DECLARATION_PART = 5;
   ...
   * @generated
   */
  int VARIABLE_IDENTIFIER_LIST = 7;
   ...
   * @generated
   */
  int CONSTANT_DEFINITION_PART = 10;
   ...
   * @ordered
   */
  int STRUCTURED_STATEMENT__ASSIGNMENT = 0;
   ...
   * @ordered
   */
  int ANY_NUMBER_FEATURE_COUNT = 1;
   ...
   * @ordered
   */
  int UNSIGNED_NUMBER__INTEGER = ANY_NUMBER__INTEGER;
   ...
   * @ordered
   */
  int UNSIGNED_NUMBER_FEATURE_COUNT = ANY_NUMBER_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SIMPLE_STATEMENT_FEATURE_COUNT = 1;
  ...
  /**
   * The feature id for the '<em><b>Ubrange</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SIMPLE_TYPE__UBRANGE = 0;
   ...
   * @ordered
   */
  int ENUMERATED_TYPE__INITIAL_CONST = 0;
   ...
   * @ordered
   */
  int ENUMERATED_TYPE__FINAL_CONST = 1;
   ...
   * @ordered
   */
  int ENUMERATED_TYPE__SUBRANGE = 2;
   ...
   * @ordered
   */
  int ENUMERATED_TYPE_FEATURE_COUNT = 4;
   ...
   * @ordered
   */
  int SIGNED_NUMBER__INTEGER = ANY_NUMBER__INTEGER;
   ...
   * @ordered
   */
  int SIGNED_NUMBER_FEATURE_COUNT = ANY_NUMBER_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.pascal.pascal.structured_statement#getAssignment <em>Assignment</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Assignment</em>'.
   * @see org.xtext.example.pascal.pascal.structured_statement#getAssignment()
   * @see #getstructured_statement()
   * @generated
   */
  EReference getstructured_statement_Assignment();
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.pascal.pascal.simple_type#getUbrange <em>Ubrange</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Ubrange</em>'.
   * @see org.xtext.example.pascal.pascal.simple_type#getUbrange()
   * @see #getsimple_type()
   * @generated
   */
  EReference getsimple_type_Ubrange();
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.pascal.pascal.enumerated_type#getInitialConst <em>Initial Const</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Initial Const</em>'.
   * @see org.xtext.example.pascal.pascal.enumerated_type#getInitialConst()
   * @see #getenumerated_type()
   * @generated
   */
  EReference getenumerated_type_InitialConst();

  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.pascal.pascal.enumerated_type#getFinalConst <em>Final Const</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Final Const</em>'.
   * @see org.xtext.example.pascal.pascal.enumerated_type#getFinalConst()
   * @see #getenumerated_type()
   * @generated
   */
  EReference getenumerated_type_FinalConst();

  /**
   * Returns the meta object for the attribute '{@link org.xtext.example.pascal.pascal.enumerated_type#getSubrange <em>Subrange</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Subrange</em>'.
   * @see org.xtext.example.pascal.pascal.enumerated_type#getSubrange()
   * @see #getenumerated_type()
   * @generated
   */
  EAttribute getenumerated_type_Subrange();

  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.pascal.pascal.enumerated_type#getConst <em>Const</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Const</em>'.
   * @see org.xtext.example.pascal.pascal.enumerated_type#getConst()
   * @see #getenumerated_type()
   * @generated
   */
  EReference getenumerated_type_Const();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference STRUCTURED_STATEMENT__ASSIGNMENT = eINSTANCE.getstructured_statement_Assignment();
    ...
    /**
     * The meta object literal for the '<em><b>Ubrange</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference SIMPLE_TYPE__UBRANGE = eINSTANCE.getsimple_type_Ubrange();
     ...
     * @generated
     */
    EReference ENUMERATED_TYPE__INITIAL_CONST = eINSTANCE.getenumerated_type_InitialConst();
     ...
     * @generated
     */
    EReference ENUMERATED_TYPE__FINAL_CONST = eINSTANCE.getenumerated_type_FinalConst();
     ...
     * @generated
     */
    EAttribute ENUMERATED_TYPE__SUBRANGE = eINSTANCE.getenumerated_type_Subrange();
     ...
     * @generated
     */
    EReference ENUMERATED_TYPE__CONST = eINSTANCE.getenumerated_type_Const();
