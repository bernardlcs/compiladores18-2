 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.constant_definition_part#getConsts <em>Consts</em>}</li>
 * </ul>
 *
...
public interface constant_definition_part extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getconstant_definition_part_Consts()
