 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.type_definition_part#getTypes <em>Types</em>}</li>
 * </ul>
 *
...
public interface type_definition_part extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#gettype_definition_part_Types()
