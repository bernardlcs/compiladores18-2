 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.simple_expression#getPrefixOperator <em>Prefix Operator</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.simple_expression#getTerms <em>Terms</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.simple_expression#getOperators <em>Operators</em>}</li>
 * </ul>
 *
...
public interface simple_expression extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getsimple_expression_PrefixOperator()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.simple_expression#getPrefixOperator <em>Prefix Operator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getsimple_expression_Operators()
   * @model unique="false"
   * @generated
   */
